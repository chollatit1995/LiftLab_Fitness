...
- **Member Portal** — สมาชิก login เองที่ `/portal` เพื่อดูแพ็กเกจ วันหมดอายุ และตารางการจองของตัวเอง
...
ระบบมีทางเข้า 2 ฝั่ง แยก cookie และแยกตารางกันคนละใบ

| ฝั่ง | หน้า login | ตารางบัญชี | ใครใช้ |
|------|-----------|-----------|--------|
| หลังบ้าน | `/login` | `app_users` | admin / manager / staff |
| สมาชิก | `/portal/login` | `member_users` | ลูกค้าฟิตเนส |
...
**สมาชิก** — เปิดหน้าจัดการสมาชิก กดไอคอนกุญแจเพื่อตั้งรหัสผ่านชั่วคราวให้ แล้วแจ้งลูกค้าไป login ที่ `/portal/login` ระบบบังคับให้เปลี่ยนรหัสเองเมื่อเข้าครั้งแรก
