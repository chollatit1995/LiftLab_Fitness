...
> บัญชีเริ่มต้นชื่อ `Admin` / `Manager` รหัส `LiftLab@2026` — ระบบจะบังคับให้ตั้งรหัสใหม่ตอน login ครั้งแรก

> ชื่อคนในระบบ (สมาชิก พนักงาน ผู้ใช้) ต้องเป็น**ภาษาอังกฤษเท่านั้น** เช่น `Somchai Jaidee`
