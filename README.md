...
- **Member Portal** — สมาชิก login ที่ `/login` เหมือนพนักงาน แล้วระบบพาไป `/portal` เพื่อดูแพ็กเกจ วันหมดอายุ และตารางการจองของตัวเอง
...
ทุกคนเข้าที่ `/login` หน้าเดียว ระบบตรวจว่าอีเมลเป็นพนักงานหรือสมาชิกแล้วพาไปปลายทางเองอัตโนมัติ
...
ลำดับการตรวจคือพนักงานก่อน ถ้าอีเมลไม่มีใน `app_users` หรือรหัสไม่ตรง ค่อยตรวจ `member_users` กรณีอีเมลเดียวกันมีทั้งสองตาราง ฝั่งพนักงานจะชนะ การเทียบอีเมลไม่สนตัวพิมพ์เล็กใหญ่และตัดช่องว่างหัวท้ายให้
...
**สมาชิก** — เปิดหน้าจัดการสมาชิก กดไอคอนกุญแจเพื่อตั้งรหัสผ่านชั่วคราวให้ แล้วแจ้งลูกค้าไป login ที่ `/login` ระบบบังคับให้เปลี่ยนรหัสเองเมื่อเข้าครั้งแรก
